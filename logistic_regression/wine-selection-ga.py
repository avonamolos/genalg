...
# print(ga.best_solutions_fitness) # ова е листа со accuracies на тест сетот
# print("==================")

# best_idx = np.argmax(ga.best_solutions_fitness) # најди го највисокиот accuracy и најди му го неговиот индекс

# best_solution = ga.best_solutions[best_idx] # на истиот тој индекс ќе го има и најдоброто решение тоест feature subset-от
# best_fitness = ga.best_solutions_fitness[best_idx] # еве го највисокото accuracy

# print("GLOBAL best fitness:", best_fitness) # го принта највисокото accuracy

# selected_features = feature_names[best_solution == 1] # од најдоброто решение ќе ги земе само потребните колони (каде што има 1)
# print("Final selected features:", list(selected_features)) # ќе ги напише кои се
# print("Number of features:", len(selected_features)) # и колку се на број
# print("Number of all features:", len(feature_names))
# # ======FINAL TEST======================
